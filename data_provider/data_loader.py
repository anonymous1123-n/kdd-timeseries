...
class Dataset_ETT_minute(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='ETTm2.csv',
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        # print("Columns after reordering:", df_raw.columns)
        # print(cols)
        ...
        border1 = border1s[self.set_type]
        border2 = border2s[self.set_type]
        # print(f"Data split indices: [{border1}:{border2}]")
        ...
        # print(f"Feature data shape before scaling: {df_data.shape}")
        ...
        # print(f"Timestamp data shape: {data_stamp.shape}")

        self.data_x = data[border1:border2]
        self.data_y = data[border1:border2]
        self.data_stamp = data_stamp

        # print(f"data_x shape: {self.data_x.shape}, data_y shape: {self.data_y.shape}")
